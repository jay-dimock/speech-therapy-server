...
module.exports = (app) => {
  ...
  app.get(
    "/api/speech/reports/allexercises/:timezone/:userId",
    ExerciseController.allExercises
  );
  app.get(
    "/api/speech/reports/alldates/:timezone/:userId",
    ExerciseController.dates
  );
  app.get(
    "/api/speech/reports/onedate/:date/:timezone/:userId",
    ExerciseController.date
  );
};
